...
export const HeroHighlight = ({
  ...
  return (
    <div
      ...
      <div className={twMerge("relative z-20", className)}>{children}</div>
    </div>
  );
};
...
return (
    <motion.span
        ...
        className={twMerge(
            `relative inline-block rounded-lg bg-gradient-to-r from-yellow-700 to-orange-900 px-1 pb-1 dark:from-yellow-700 dark:to-orange-900`,
            className
        )}>
        {children}
    </motion.span>
